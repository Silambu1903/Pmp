...
class TaskAssignListManager extends ConsumerStatefulWidget {

  ProjectManagementProcessProjectAssignManager? data;


  TaskAssignListManager({Key? key, this.data}) : super(key: key);

  @override
  ConsumerState<TaskAssignListManager> createState() =>
      _TaskAssignListManagerState();
}

class _TaskAssignListManagerState extends ConsumerState<TaskAssignListManager> {
  @override
  void initState() {
        ...
        onTap: () {
         Navigator.of(context).push(
            MaterialPageRoute(
              ...
              builder: (context) => DailyTaskManager(
                data: widget.data,
                taskIdList: data,
              ),
            ),
